<script lang="ts">
	import { currentDate, monthDays } from '$lib/components/calendar/stores/calendar';
	import { filteredEvents, getEventsForDay } from '$lib/components/calendar/stores/events';
	import { getDayClassNames } from '$lib/components/calendar/utils/date-utils';
