...
import type { Invoice, InvoiceStatus, LineItem } from '$lib/components/invoice/types';
...
const initialInvoices: Invoice[] = [
	{
		...
		items: [
			{ id: '1', description: 'Website Design', quantity: 1, rate: 1200, amount: 1200 },
			{ id: '2', description: 'Development', quantity: 20, rate: 150, amount: 3000 }
		],
	...
	},
	{
		...
		items: [{ id: '1', description: 'Consulting Services', quantity: 10, rate: 200, amount: 2000 }],
	...
	},
	{
		...
		items: [
			{ id: '1', description: 'AI Integration', quantity: 1, rate: 3500, amount: 3500 },
			{ id: '2', description: 'Support Package', quantity: 1, rate: 500, amount: 500 }
		],
	...
	},
	{
		...
		items: [
			{ id: '1', description: 'Security Consultation', quantity: 1, rate: 5000, amount: 5000 }
		],
