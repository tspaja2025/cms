<script lang="ts">
	import { currentDate } from '$lib/custom/calendar/store/calendar';
	import { filteredEvents } from '$lib/custom/calendar/store/events';
	import { startOfWeek, endOfWeek, eachDayOfInterval, format, isToday, isSameDay } from 'date-fns';
	import { getHourLabels, getTimeValue } from '$lib/custom/calendar/utils/date-utils';
