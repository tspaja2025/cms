<script lang="ts">
	...
	import { initialInvoices } from '$lib/custom/invoice/store/data';
...
<Card.Root>
	...
	<Card.Content class="space-y-4">
		...
		{#if paymentMethod === 'cards'}
			<div class="space-y-4">
				<FormField label="Card Number" id="card_number" />
				<div class="flex space-x-4">
					<FormField label="Name" id="name" />
					<FormField label="Expiration Date" id="expiration_date" />
				</div>
				<FormField label="CVV Code" id="cvv_code" />
	...
	<Card.Content class="flex flex-col space-y-4">
		<div class="flex space-x-4">
			<div class="flex-1 space-y-4">
				...
				<FormField label="TAX ID" id="tax_id" />
				<FormField label="Mobile Number" id="mobile_number" />
			</div>
			<div class="flex-1 space-y-4">
				<FormField label="Billing Email" id="billing_email" />
				<FormField label="Billing VAT Number" id="vat_number" />
				<div class="space-y-2">
		...
		<FormField label="Billing Address" id="billing_address" />
		<div class="flex space-x-4">
			<div class="flex-1 space-y-4">
				<FormField label="State" id="stateTwo" />
			</div>
			<div class="flex-1 space-y-4">
				<FormField label="Zip Code" id="zip_codeTwo" />
			</div>
		</div>
	</Card.Content>
