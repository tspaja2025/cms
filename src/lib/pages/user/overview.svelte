<script>
	...
	import { invoiceList, projectList } from '$lib/store';
						...
						<Table.Cell>
							...
							<DropdownMenu.Root>
								...
								<DropdownMenu.Content>
									...
									<DropdownMenu.Item><SquarePenIcon />Edit</DropdownMenu.Item>
									<DropdownMenu.Item><FilesIcon />Duplicate</DropdownMenu.Item>
								</DropdownMenu.Content>
							</DropdownMenu.Root>
						</Table.Cell>
					</Table.Row>
