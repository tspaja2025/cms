<script lang="ts">
	...
	import {
		...
		toggleStar,
		addEmail
	} from '$lib/custom/email/store/email-store';
...
<div class="flex flex-col bg-white">
	...
	<div class="flex">
		...
		<div class="flex w-72 flex-col space-y-2 border-r border-neutral-200 p-4">
			...
			<Dialog.Root open={$isComposeOpen} onOpenChange={handleClose}>
				...
				<Dialog.Content class="flex max-h-[80vh] flex-col p-0 sm:max-w-xl">
					...
					<Dialog.Footer class="flex !justify-between border-t border-neutral-200 px-4 py-2">
		...
		<div class="flex w-full">
			<div class="h-full w-96 border-r border-gray-200 {$selectedEmailId ? 'hidden md:block' : ''}">
				<div
					class="h-full w-96 border-r border-gray-200 {$selectedEmailId ? 'hidden md:block' : ''}"
				>
					<!-- Email List -->
						...
						<div class="flex items-center justify-between border-b border-gray-200 p-3">
							...
							<div class="flex items-center gap-1">
								<Tooltip.Root>
									...
									<Tooltip.Content>
										<p>{$selectedEmail.isStarred ? 'Remove star' : 'Add star'}</p>
									</Tooltip.Content>
								</Tooltip.Root>
