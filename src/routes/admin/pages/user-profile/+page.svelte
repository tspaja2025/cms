    ...
    <div class="absolute top-4 right-4">
      <DropdownMenu.Root>
        ...
        <DropdownMenu.Content align="end">
          ...
          <DropdownMenu.Item onSelect={() => console.log("Share")}
          ...
          {#each teams as team, teamIndex (teamIndex)}
            <div class="team-card">
              <div class="mb-3 flex items-start justify-between">
                ...
                <span
                  class="px-2 py-1 {team.color} rounded-full text-xs font-medium"
                >
                  {team.role}
                </span>
              </div>
          ...
          <Card.Root class="w-full p-6">
            <Card.Header>
              <div class="mb-2 flex items-center gap-3">
                ...
                <Badge
                  class="rounded-full px-2 py-1 {project.statusColor} text-xs font-medium"
                >
                  {project.status}
                </Badge>
              </div>
            ...
            <Card.Content>
              ...
              <div class="space-y-1">
                ...
                <div class="text-muted-foreground flex justify-between text-xs">
                  ...
                  <span
                    >Due: {new Date(project.dueDate).toLocaleDateString()}</span
                  >
                </div>
              </div>
            </Card.Content>
