...
<div class="flex gap-4">
  <div class="w-2/5 space-y-4">
    ...
    <Card.Root class="shadow-none border-2 border-purple-500">
    ...
    <Tabs.Root value="overview">
      ...
      <Tabs.Content class="space-y-4" value="security">
        ...
        <Card.Root>
          <Card.Header>
            ...
            <Card.Description
              >Keep your account secure with authentication step.</Card.Description
            >
          </Card.Header>
          <Card.Content class="space-y-4">
            <div class="space-y-2">
            ...
            <p>
              ...
              log in. <a class="text-blue-500 hover:text-blue-600" href="/admin/user/view">Learn more.</a>
            </p>
          </Card.Content>
        </Card.Root>
        <Card.Root>
      ...
      <Tabs.Content class="space-y-4" value="billing-plans">
        ...
        <Card.Root>
          ...
          <Card.Content>
            Name, Billing Email, Tax ID, VAT Number, Billing Address, Contact,
            Landmark, Country, State, Zip Code
          </Card.Content>
        </Card.Root>
      </Tabs.Content>
      ...
      <Tabs.Content class="space-y-4" value="connections">
        ...
        <Card.Root>
          <Card.Header>
            ...
            <Card.Description
              >Display content from social accounts on your site</Card.Description
            >
          </Card.Header>
          <Card.Content>
